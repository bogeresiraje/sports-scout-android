...
export default class ConfirmAccount extends Component {
    ...
    _tryAgain = () => {
        this.setState({ loading: false, somethingWrong: false, submittingCodeIndicator: false })
    }
                            ...
                            <View style={ layout.justifyMaxGrey }>
                                ...
                                
                                {
                                    this.state.submittingCodeIndicator ?
                                        ...
                                        <TouchableOpacity
                                            style={ buttons.autoArmyGreenButton }
